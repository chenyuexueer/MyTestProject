...
public class User3 {
    ...
    @Ignore
    public User3(int uid, String firstName, String lastName) {
        this.uid = uid;
        this.firstName = firstName;
        this.lastName = lastName;
    }
    @Ignore
    public User3(String firstName, String lastName, int age) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.age = age;
    }
    @Ignore
    public User3(int uid, String firstName, String lastName, int age) {
        this.uid = uid;
        this.firstName = firstName;
        this.lastName = lastName;
        this.age = age;
    ...
    @Ignore
    public User3(int uid, String firstName, String lastName, String tel) {
        this.uid = uid;
        this.firstName = firstName;
        this.lastName = lastName;
        this.tel = tel;
