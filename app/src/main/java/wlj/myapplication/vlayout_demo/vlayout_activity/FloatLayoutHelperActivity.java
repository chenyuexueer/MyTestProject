...
public class FloatLayoutHelperActivity extends AppCompatActivity {
    ...
    public static MyRecyclerAdapter init(Context context){
        ...
        floatLayoutHelper.setDefaultLocation(20,200);//默认悬浮位置（x轴，y轴）
        MyRecyclerAdapter myRecyclerAdapter=new MyRecyclerAdapter(context,floatLayoutHelper,"FloatLayoutHelper");
        return  myRecyclerAdapter;
    }
}
