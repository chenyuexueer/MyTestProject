...
public class MyChooseBgView extends View {
    /**
     * 是否是左边被选中
     */
    ...
    public MyChooseBgView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lightTextPaint.setTextAlign(Paint.Align.CENTER);
        lightTextPaint.setColor(Color.BLUE);// 文字颜色
    }

    public MyChooseBgView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyChooseBgView(Context context) {
        this(context, null);
    }
    ...
    private void drawText(Canvas canvas) {
        ...
        // 文字高度矫正
        Paint.FontMetrics fm = lightTextPaint.getFontMetrics();
