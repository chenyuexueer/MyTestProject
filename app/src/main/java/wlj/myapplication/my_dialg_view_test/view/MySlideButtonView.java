 ...
 * 说明：滑动开关view
 * 
 * 一个监听点击和滑动时间的按钮 滑动时,背景颜色随着滑动的距离变深
 * ================================================
 */

public class MySlideButtonView extends View {
    /**
     * 关闭状态的背景色
     */
    ...
    public MySlideButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MySlideButtonView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySlideButtonView(Context context) {
        this(context, null);
    }
