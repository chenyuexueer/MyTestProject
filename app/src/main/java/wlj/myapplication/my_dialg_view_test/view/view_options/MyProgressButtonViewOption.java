package wlj.myapplication.my_dialg_view_test.view.view_options;
 ...
 * 时间： 2018/5/29.
 * 说明：这是进度条按钮 MyProgressButton 的参数设置类
 * ================================================
 */

public class MyProgressButtonViewOption {
    ...
    public MyProgressButtonViewOption(Builder builder) {
        super();
