...
public class MyGradualView extends View {
    ...
    public MyGradualView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);//这个要api 21
        paint = new Paint();
        paint.setAntiAlias(true);
    }

    public MyGradualView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr,0);
    }

    public MyGradualView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MyGradualView(Context context) {
        this(context,null);
    }
