...
public class MyThermometerView extends View {
    /**
     * 外壳画笔
     */
    ...
    public MyThermometerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MyThermometerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyThermometerView(Context context) {
        this(context, null);
    }
    /**
     * 设置液体最高位置
