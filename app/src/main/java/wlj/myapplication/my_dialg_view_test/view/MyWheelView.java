...
public class MyWheelView extends View {
     ...
     * 参数集合
     */
    private MyWheelViewOption option = null;
    /**
     * 回掉监听
     */
    private MyWheelViewListener listener = null;
    /**
     * Y轴偏移量
     */
    ...
    public MyWheelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        magnifierPaint.setTextAlign(Paint.Align.CENTER);
        magnifierBgPaint = new Paint();
        magnifierBgPaint.setAntiAlias(true);
        magnifierBgPaint.setTextAlign(Paint.Align.CENTER);
    }
    ...
    private Bitmap getMagnifier(){
        ...
        Bitmap output = Bitmap.createBitmap(width,
                textSize+intervalHeight, Bitmap.Config.ARGB_8888);
    ...
    private void inertia(){
        ...
        if(Math.abs(speed)>10){
            ...
            speed = 0;
            if(listener!=null){
                listener.onMyWheelViewChange(this, list.get(position), position);
            }
        }else{
            if(listener!=null){
                listener.onMyWheelViewChange(this, list.get(position), position);
    ...
    public MyWheelViewOption getOption() {
        return option;
    }

    public void setOption(MyWheelViewOption option) {
        this.option = option;
        initType = false;
    }

    public interface MyWheelViewListener {
        public void onMyWheelViewChange(MyWheelView view, String value, int position);
    }

    public MyWheelViewListener getListener() {
        return listener;
    }

    public void setListener(MyWheelViewListener listener) {
