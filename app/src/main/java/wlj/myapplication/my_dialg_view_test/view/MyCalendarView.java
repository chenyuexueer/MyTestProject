...
public class MyCalendarView extends View {
    ...
    public MyCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
         ...
         * 获得我们所定义的自定义样式属性
         ...
         <attr name="weeks_color" format="color" />
         ...
         <attr name="today" format="integer" />
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.calendarview_backgroundColor:
                ...
                case R.styleable.calendarview_today:
                    ...
                    break;
                case R.styleable.calendarview_textColor:
    ...
    private void drawText(Canvas canvas, int[] daysArray, int xOffset, int yOffset, int y, int m) {
        ...
        Paint.FontMetrics fm = textPaint.getFontMetrics();//画笔的字体设置
