...
public class MyScratchCardView  extends View {
    //参数类
    private MyScratchCardViewOption option;
    //覆盖的画笔
    ...
    public MyScratchCardView(Context context) {
        this(context,null);
    }
    public MyScratchCardView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }
    public MyScratchCardView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param option
     */
    public void setOption(MyScratchCardViewOption option) {
        this.option = option;
        init();
        invalidate();
    }
