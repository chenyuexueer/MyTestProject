...
public class MyWaterDropLoadView extends View {
    /**
     * view的参数
     */
    private MyWaterDropLoadViewOption option;
    /**
     * 波浪的节点
     */
    ...
    public MyWaterDropLoadView(Context context, MyWaterDropLoadViewOption option) {
        this(context);
        this.option = option;
        dataSet();
    }
    public MyWaterDropLoadView(Context context) {
        this(context, null, 0);
    }
    public MyWaterDropLoadView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public MyWaterDropLoadView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOption(MyWaterDropLoadViewOption option) {
        this.option = option;
        dataSet();
    }
