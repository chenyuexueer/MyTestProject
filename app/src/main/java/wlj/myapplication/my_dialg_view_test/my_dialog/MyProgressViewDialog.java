...
import wlj.myapplication.my_dialg_view_test.view.MyProgressView;

/**
 * ================================================
 * Created by ${chenyuexueer}
 * 时间： 2018/5/29.
 * 说明：加载进度view  的  dialog
 * ================================================
 */

public class MyProgressViewDialog extends Dialog {
    /**
     * 进度总数
     * 建议100
     */
    ...
    public MyProgressViewDialog(Context context, int allInt, int havingInt) {
        super(context);
        this.allInt = allInt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_dialog_progress_view);
        getWindow().setBackgroundDrawableResource(android.R.color.transparent);
        progressView = (MyProgressView) findViewById(R.id.dialog_progress_pro);
